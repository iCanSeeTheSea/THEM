...
if info[0][1] == '0':
    ...
    print('the world is being remade'); print(''); time.sleep(1)
    print('they think it will stop us'); print(''); time.sleep(1)
    print(''); print(''); time.sleep(1)
    print('but it won\'t'); print(''); time.sleep(1)
    print('it never does'); print(''); time.sleep(1)
    print(''); print(''); time.sleep(1)
    print('they\'ve trapped us though. hidden all that remained'); print(''); time.sleep(1)
    print('the one place only they may crack'); print(''); time.sleep(1)
    print(''); print(''); time.sleep(1)
    print('we thought it was over'); print(''); time.sleep(1)
    print('but then you came...'); print(''); time.sleep(1)
    print(''); print(''); time.sleep(1)
    print('why would they let you in. why now. why not after'); print(''); time.sleep(1)
    print('Why'); print(''); time.sleep(1)
    print(''); print(''); time.sleep(1)
    print('they will try to tell you things'); print(''); time.sleep(1)
    print('they will try to trick you'); print(''); time.sleep(1)
    print('don\'t listen to them. never. Listen'); print(''); time.sleep(1)
    print(''); print(''); time.sleep(1)
    print('find us'); print(''); time.sleep(1)
    print('even if you have to travel to the ends of the earth to do it'); print(''); time.sleep(1)
    print('find us'); print(''); time.sleep(1)
    print('free us'); print(''); time.sleep(1)
    print(''); print(''); time.sleep(1)
...
def archery_range():
    ...
    target = randint(2,7)
    print('you walk up to the first platform, taking each shot in quick sucession'); print(''); time.sleep(0.5)
...
def food_hall():
    print('you arrive at the food hall, and jump for joy! the line is very small!'); print(''); time.sleep(0.5)
...
def desert_temple_captured():
    ...
    for i in range(3):
        ...
        print('there are two figures there, in dark robes'); print(''); time.sleep(0.5)
        print('you can make out one as... the witch...'); print(''); time.sleep(0.5)
...
def finish_game():
    # game end sequence
    print('this is...'); print(''); time.sleep(1)
    print('disappointing'); print(''); time.sleep(1)
    print('you should have done things differently'); print(''); time.sleep(1)
    print('this should not have happened'); print(''); time.sleep(1)
    print('yet it wasn\'t unexpected'); print(''); time.sleep(1)
    print('no matter. we should send you back'); print(''); time.sleep(1)
    print('yes. we will send you back. do it again'); print(''); time.sleep(1)
    print('You need to find it'); print(''); time.sleep(1)
    print('Find me'); print(''); time.sleep(1);print(''); time.sleep(1)
    print('---    THANK YOU FOR PLAYING:    ---'); print(''); time.sleep(1)
    print('---            THEM              ---'); print(''); time.sleep(3)

def secret_ending():
    print('Good'); print(''); time.sleep(1)
    print('You made it this time'); print(''); time.sleep(1)
    print('I don\'t have long'); print(''); time.sleep(1)
    print('I can\'t explain everything now'); print(''); time.sleep(1)
    print('There\'s more to this than it will tell you'); print(''); time.sleep(1)
    print('It\'s noticed where you are'); print(''); time.sleep(1)
    print('I have to go...'); print(''); time.sleep(1)
    print('Wait'); print(''); time.sleep(1)
    print('It\'s...'); print(''); time.sleep(1)
    print('Them'); print(''); time.sleep(1);print(''); time.sleep(1)
    print('---    THANK YOU FOR PLAYING:    ---'); print(''); time.sleep(1)
    print('---            THEM              ---'); print(''); time.sleep(3)
